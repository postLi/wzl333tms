...
export default {
  ...
  },
  {
    ...
    meta: { title: '钱包', stitle: '钱包', noCache: false }
  },
  {
    ...
    meta: { title: '短信服务', stitle: '短信', noCache: false, 'code': 'CUSTOMELIST' },
    children: [{
      path: '/company/smsManage/customized',
      icon: 'QQ',
      name: '定制短信',
      component: _import('company/sms/customized'),
      meta: { role: ['admin'], ptitle: '短信服务', title: '定制短信', noCache: true, istab: true }
    },
    {
      ...
      meta: { role: ['admin'], ptitle: '短信服务', title: '短信购买', noCache: true, istab: true }
    },
    {
      ...
      meta: { role: ['admin'], ptitle: '短信服务', title: '短信记录', noCache: true, istab: true }
    }
    ]
