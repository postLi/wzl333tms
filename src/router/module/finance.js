...
export default {
  ...
  children: [
    ...
    {
      path: '/finance/reconciliation', icon: 'QQ', redirect: '/finance/reconciliation/carrier', name: '财务对账', component: _import('finance/reconciliation/index'), meta: { role: ['admin'], title: '财务对账', noCache: false, istab: true },
      children: [
        {
