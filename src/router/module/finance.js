...
export default {
  ...
  },
  {
    ...
    children: [{
      ...
      meta: { role: ['admin'], ptitle: '应收账款', title: '全部', noCache: true, istab: true, code: 'FINANCE_RECLIST1' }
    },
    {
      ...
      meta: { role: ['admin'], ptitle: '应收账款', title: '现付', noCache: true, istab: true, code: 'FINANCE_RECLIST2' }
    },
    {
      ...
      meta: { role: ['admin'], ptitle: '应收账款', title: '到付', noCache: true, istab: true, code: 'FINANCE_RECLIST3' }
    },
    {
      ...
      meta: { role: ['admin'], ptitle: '应收账款', title: '回单付', noCache: true, istab: true, code: 'FINANCE_RECLIST4' }
    },
    {
      ...
      meta: { role: ['admin'], ptitle: '应收账款', title: '月结', noCache: true, istab: true, code: 'FINANCE_RECLIST5' }
    },
    {
      ...
      meta: { role: ['admin'], ptitle: '应收账款', title: '异动费用', noCache: true, istab: true, code: 'FINANCE_RECLIST6' }
    }
    ]
  },
  {
    ...
    meta: { role: ['admin'], title: '应付账款', 'code': 'FINANCE_PAY', istab: true, noCache: false },
    children: [{
      ...
      meta: { role: ['admin'], title: '运单结算', noCache: false, code: 'PAY_SHIP' },
      children: [
        {
          ...
          meta: { role: ['admin'], ptitle: '运单结算', title: '回扣', noCache: true, istab: true, code: 'SHIP_PAYLIST1' }
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '运单结算', title: '中转费', noCache: true, istab: true, code: 'SHIP_PAYLIST2' }
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '运单结算', title: '实际提货费', noCache: true, istab: true, code: 'SHIP_PAYLIST3' }
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '运单结算', title: '异动费用', noCache: true, istab: true, code: 'SHIP_PAYLIST4' }
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '运单结算', title: '异常理赔', noCache: true, istab: true, code: 'SHIP_PAYLIST5' }
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '运单结算', title: '其他费用支出', noCache: true, istab: true, code: 'SHIP_PAYLIST6' }
        }
      ]
    },
    {
      ...
      children: [
        {
          ...
          meta: { role: ['admin'], ptitle: '车费结算', title: '短驳费', noCache: true, istab: true, code: 'PAY_LOADLIST1' }
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '车费结算', title: '送货费', noCache: true, istab: true, code: 'PAY_LOADLIST2' }
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '车费结算', title: '发车汇总', noCache: true, istab: true, code: 'PAY_LOADLIST3' }
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '车费结算', title: '到车汇总', noCache: true, istab: true, code: 'PAY_LOADLIST4' }
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '车费结算', title: '整车保险费', noCache: true, istab: true, code: 'PAY_LOADLIST5' }
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '车费结算', title: '发站装卸费', noCache: true, istab: true, code: 'PAY_LOADLIST6' }
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '车费结算', title: '发站其他费', noCache: true, istab: true, code: 'PAY_LOADLIST7' }
        },
        {
        ...
        },
        {
          ...
          meta: { role: ['admin'], ptitle: '车费结算', title: '到站其他费', noCache: true, istab: true, code: 'PAY_LOADLIST9' }
        }
      ]
    },
    {
  ...
  },
  {
    ...
    meta: { role: ['admin'], title: '资金流水', 'code': 'FINANCE_FLOW', noCache: false, code: 'FINANCE_FLOW' }
  },
  {
  ...
  },
  {
    ...
    meta: { role: ['admin'], title: '财务对账', noCache: false, istab: true, code: 'FINANCE_verification' },
    children: [{
        ...
        // },
    {
      ...
      meta: { role: ['admin'], title: '客户对账', noCache: false, code: 'FINANCE_CUSTOMER' }
    },
    {
      ...
      meta: { role: ['admin'], title: '车费对账', noCache: false, code: 'FINANCE_CARFEE' },
      children: [
        {
  ...
  },
  {
    ...
    meta: { role: ['admin'], title: '异动费用', 'code': 'FINANCE_ABNORAML', noCache: false, code: 'FINANCE_ABNORAML' }
  },
  {
    ...
    meta: { role: ['admin'], title: '货款管理', noCache: false, code: 'FINANCE_GOODSFUNDS' },
    children: [{
      path: '/finance/payment/recycle',
      icon: 'QQ',
      name: '货款回收',
      component: _import('finance/payment/recycle'),
      meta: { role: ['admin'], ptitle: '货款管理', istab: true, title: '货款回收', noCache: false, code: 'FINANCE_AGENCYFUND1' }
    },
    {
      ...
      meta: { role: ['admin'], ptitle: '货款管理', istab: true, title: '货款汇款', noCache: false, code: 'FINANCE_AGENCYFUND2' }
    },
    {
      ...
      meta: { role: ['admin'], ptitle: '货款管理', istab: true, title: '货款到账', noCache: false, code: 'FINANCE_AGENCYFUND3' }
    },
    {
      ...
      meta: { role: ['admin'], ptitle: '货款管理', istab: true, title: '货款发放', noCache: false, code: 'FINANCE_AGENCYFUND4' }
    }
    ]
  },
  {
    ...
    meta: { role: ['admin'], title: '员工交账', 'code': 'FINANCE_ACCOUNT', noCache: false, code: 'FINANCE_ACCOUNT' }
  },
  {
  ...
  },
  {
    ...
    meta: { role: ['admin'], title: '收支方式管理', 'code': 'FINANCE_IOMANAGE', noCache: false, code: 'FINANCE_IOMANAGE' }
  },
  {
