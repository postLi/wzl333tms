<template>
  <pop-right :title="popTitle" :isShow="popVisible" @close="closeMe" class="_storagesPop" v-loading="loading">
                ...
                <div class="pact_top">
                  ...
                  <div class="sTitle">
                    <el-form-item label="" prop="contractName" class="contractNameClass">
                      <el-input v-model="sendContract.contractName" auto-complete="off" :disabled="!editFn" clearable
                ...
                <div class="pact_content">
                  <div class="pact_title">
                    <el-form-item label="委托方:" prop="nomineeCompany">
                      <el-input v-model="sendContract.nomineeCompany" auto-complete="off" :disabled="!editFn" clearable
                                :maxlength="20"></el-input>
                    </el-form-item>
                  ...
                  <div class="pact_title">
                    <el-form-item label="承运方:" prop="">
                      <el-select v-model="sendContract.carrier" :disabled="!editFn">
                        <el-option
                          v-for="item in carrierItem"
                          :key="item.value"
                          :label="item.value"
                          :value="item.value" class="artselect-lll" style="width: 340px">
                        </el-option>
                      </el-select>
    ...
    <div slot="footer" class="dialog-footer" v-else>
      ...
      <TableSetup :popVisible="setupTableVisible" :columns="tableColumn" code="ORDER_ARTER"
                  @close="setupTableVisible = false" @success="setColumn"></TableSetup>
    </div>
