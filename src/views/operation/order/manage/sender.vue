<template>
  <div class="tab-content manage-content" v-loading="loading">
    ...
    <div class="tab_info">
      <div class="btns_box">
          <el-button type="primary" :size="btnsize" icon="el-icon-circle-plus" plain @click="doAction('add')" v-has:code="ORDERMANGER_ADD">新建</el-button>
          <el-button type="success" :size="btnsize" icon="el-icon-success" @click="doAction('acceptance')" plain v-has:code="ORDERMANGER_REVER">受理</el-button>
          <el-button type="warning" :size="btnsize" icon="el-icon-error" @click="doAction('refuse')" plain v-has:code="ORDERMANGER_CANCEL">拒绝</el-button>
          <el-button type="primary" :size="btnsize" icon="el-icon-edit" @click="doAction('modify')" plain v-has:code="ORDERMANGER_EDIT">修改</el-button>
          <el-button type="info" :size="btnsize" icon="el-icon-circle-close-outline" @click="doAction('cancel')" plain v-has:code="ORDERMANGER_NO">作废</el-button>
          <el-button type="danger" :size="btnsize" icon="el-icon-delete" @click="doAction('delete')" plain v-has:code="ORDERMANGER_DEL">删除</el-button>
          <el-button type="primary" :size="btnsize" icon="el-icon-download" @click="doAction('export')" plain v-has:code="ORDERMANGER_EXP">导出</el-button>
