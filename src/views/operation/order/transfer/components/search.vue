<template>
  <el-form :inline="true" :size="btnsize" label-position="right" :rules="rules" :model="searchForm"  class="transfer_searchinfo clearfix">
    ...
    <el-form-item v-if="!isbatch" label="出发城市:" class="searchinfo--order">
      ...
      <el-form-item class="transfer_searchinfo--btn">
