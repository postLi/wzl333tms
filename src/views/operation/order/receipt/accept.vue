<template>
    <div class="tab-content">
        ...
        <div class="tab_info">
      <div class="btns_box">
          <el-button type="primary" :size="btnsize" icon="el-icon-sort-down" plain @click="doAction('accept')">回单接收</el-button>
      ...
      <AddMark :popVisible="popVisible" :dotInfo="dotInfo" :searchQuery="searchQuery" @close="closeAddDot" @success="fetchAllreceipt" :isModify="isModify" :isAccept="isAccept" />    
    </div>
    </div>
</template>
<script>
