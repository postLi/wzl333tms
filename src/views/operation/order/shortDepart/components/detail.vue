<template>
  <div class="detailTable">
    ...
    <div class="tab_info">
      ...
      <div class="info_tab">
        <el-table ref="multipleTable" :data="detailList" @row-click="clickDetails" @selection-change="getSelection" stripe border height="100%" :default-sort="{prop: 'id', order: 'ascending'}" tooltip-effect="dark">
          ...
          <el-table-column sortable width="120" prop="actualAmountall" label="实到件数">
            <template slot-scope="scope">
              <el-input type="number" v-model="scope.row.loadAmountall" @change="changeAmount"></el-input>
            </template>
          </el-table-column>
          <el-table-column sortable width="120" prop="actualWeigntall" label="实到重量">
            <template slot-scope="scope">
              <el-input type="number" v-model="scope.row.actualWeigntall" @change="changeWeight"></el-input>
            </template>
          </el-table-column>
          <el-table-column sortable width="120" prop="actualVolumeall" label="实到体积">
            <template slot-scope="scope">
              <el-input type="number" v-model="scope.row.actualVolumeall" @change="changeVolume"></el-input>
            </template>
          </el-table-column>
