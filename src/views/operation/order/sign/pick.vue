<template>
    <div class="tab-content" @success="fetchAllreceipt"  v-loading="loading">
      ...
      <div class="tab_info">
      <div class="btns_box">
        <el-button type="primary" :size="btnsize" icon="el-icon-circle-check-outline" plain @click="doAction('pick')" v-has:ORDERSIGN_ADD1>签收</el-button>
        <el-button type="primary" :size="btnsize" icon="el-icon-circle-close-outline" @click="doAction('cancel')" plain v-has:ORDERSIGN_CANCEL1>取消签收</el-button>
        <el-button type="primary" :size="btnsize" icon="el-icon-edit" plain @click="doAction('amend')" v-has:ORDERSIGN_EDIT1>修改</el-button>
        <el-button type="primary" :size="btnsize" icon="el-icon-upload2" @click="doAction('export')" plain v-has:ORDERSIGN_EXP1>导出</el-button>
