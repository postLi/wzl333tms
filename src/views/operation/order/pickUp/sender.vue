  ...
  <div class="tab-content" v-loading="loading">
    ...
    <div class="tab_info">
      <div class="btns_box">
        ...
        <el-button type="success" :size="btnsize" icon="el-icon-success" @click="doAction('finishPick')" plain
                   v-has:PICK_FINASH>提货完成
        </el-button>
        <el-button type="primary" :size="btnsize" icon="el-icon-menu" @click="doAction('relevance')" plain
                   v-has:PICK_SEL>关联运单
        </el-button>
