<template>
    <div class="tab-content">
      ...
      <div class="tab_info">
        <div class="btns_box">
            <el-button type="primary" :size="btnsize"  plain @click="doAction('haveGoods')">放货</el-button>
        ...
        <div class="info_tab">
          <el-table
            ...
            <el-table-column
              ...
              width="120"
              label="放货时间">
              <template slot-scope="scope">{{ scope.row.updateTime | parseTime('{y}-{m}-{d} {h}:{m}:{s}') }}</template>
            </el-table-column>
            <el-table-column
              prop="shipStatusName"
              label="运单状态"
            ...
            <el-table-column
              ...
              width="120"
              label="开单时间">
              <template slot-scope="scope">{{ scope.row.startTime | parseTime('{y}-{m}-{d} {h}:{m}:{s}') }}</template>
            </el-table-column>
            <el-table-column
