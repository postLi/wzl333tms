<template>
  <pop-right :title="popTitle" :isShow="popVisible" @close="closeMe" class="wzl_addAbnormalPop" v-loading="loading">
    <template class="wzl_addAbnormalPop-content" slot="content">
      <el-form :model="form" :rules="rules" ref="ruleForm" :label-width="formLabelWidth" :inline="true"
        ...
        <div class="box1">
          ...
          <el-form-item label="登记时间" prop="registerTime">
            <el-input :value="form.registerTime|parseTime('{y}-{m}-{d} {h}:{i}:{s}')" :maxlength="20"
          ...
          <el-form-item label="异常件数" prop="abnormalAmount">
            <el-input v-model.trim="form.abnormalAmount" v-numberOnly :maxlength="5" auto-complete="off"
                      :disabled="isCheck || isDeal ? true : false"></el-input>
          </el-form-item>
          ...
          <el-form-item label="异常金额" prop="registerFee">
            <el-input v-model="form.registerFee" v-number-only:point :maxlength="5" auto-complete="off"
                      :disabled="isCheck || isDeal ? true : false"></el-input>
          </el-form-item>
          ...
          <el-form-item class="driverRemarks label ms" label="异常描述" prop="abnormalDescribe">
            <el-input type="textarea" :maxlength="200" v-model.trim="form.abnormalDescribe"
                      :disabled="isCheck || isDeal ? true : false"></el-input>
          </el-form-item>
        ...
        <div class="box1 control" v-if="isDeal" style="height:400px">
          ...
          <el-form-item class="driverRemarks ms" label="处理意见" prop="disposeOpinion">
            <el-input type="textarea" :maxlength="200" v-model="form.disposeOpinion"
                      :disabled="isCheck ? true : false"></el-input>
          </el-form-item>
          <p class="ts">注意：问题描述最多输入200字</p>
          <p class="wz"><a>图片上传</a>注：最多可上传6张图片，每张图片不能大于5M</p>
          <!-- :class="{'disabledUpload': isCheck || isDeal}" -->
          <el-form-item class="clearfix">
            <div class="clearfix uploadcard">
              <upload :title="'本地上传'" :showFileList="true" :limit="6" listtype="picture" v-model="form.disposePicture"
