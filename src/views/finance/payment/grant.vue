...
<div class="tab-wrapper tab-wrapper-100">
  <div class="tab-content">
      ...
      <div class="tab_info">
        <div class="btns_box">
            <el-button type="primary" :size="btnsize" icon="el-icon-sort-down" plain @click="doAction('send')">货款发放</el-button>
      ...
      <AddPayment :popVisible="popVisible" :issender="true" :dotInfo="dotInfo" proptitle="货款发放" :searchQuery="searchQuery"  @close="closeAddDot" @success="featchAllpayment" :isModify="isModify" :isAccept="isAccept"/>
    </div>
</div>
</template>
<script>
import SearchForm from './components/search'
import { postGoodsfundsList } from '@/api/finance/payment'
      ...
      switch (type) {
        ...
        case 'send':
          const ids = this.selected.filter(el => {
            return el.fundsGiveoutStatus === 263
          })
