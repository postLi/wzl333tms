<template>
  <div class="tab-content miniHeaderSearch" @success="featchAllpayment"  v-loading="loading">
      ...
      <div class="tab_info">
        ...
        <div class="info_tab">
            <!-- <el-table
              ...
              <el-table-column
                prop="fundsRemittanceStatusName"
                label="汇款状态"
                width="120"
                sortable
                >
      ...
      <AddPayment :popVisible="popVisible" :issender="true" :dotInfo="dotInfo" proptitle="汇款" :searchQuery="searchQuery"  @close="closeAddDot" @success="featchAllpayment" :isModify="isModify" :isAccept="isAccept"/>
      ...
      switch (type) {
        ...
        case 'send':
          const ids = this.selected.filter(el => {
            return el.fundsRemittanceStatus === 257
          })
        ...
        case 'cancel':
          ...
          const _ids = this.selected.filter(el => {
            return el.fundsRemittanceStatus === 258 && el.fundsAccountStatus === 260
          }).map(el => {
            return el.id
          })
