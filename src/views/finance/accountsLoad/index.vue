    ...
    <transferTable style="height: calc(100% - 40px);padding:10px">
      ...
      <div style="height:100%;" slot="tableLeft" class="tableHeadItemBtn">
        ...
        <el-table ref="multipleTableRight" :data="leftTable" border @row-click="clickDetailsRight" @selection-change="getSelectionRight" tooltip-effect="dark" triped :key="tablekey" height="100%" :summary-method="getSumRight" :default-sort="{prop: 'id', order: 'ascending'}" :show-overflow-tooltip="true" :show-summary="true">
          ...
          <el-table-column prop="shipSn" width="150" label="运单号">
          </el-table-column>
          ...
          <el-table-column prop="shipReceiverMobile" sortable label="回扣" width="120">
          </el-table-column>
          <el-table-column prop="cargoName" sortable label="回扣结算状态" width="120">
          </el-table-column>
          <el-table-column prop="shipGoodsSn" sortable label="未结回扣" width="120">
          </el-table-column>
          <el-table-column prop="repertoryAmount" sortable label="已结回扣" width="120">
          </el-table-column>
          <el-table-column prop="repertoryWeight" sortable label="发货方" width="120">
          </el-table-column>
          <el-table-column prop="repertoryVolume" sortable label="收货方" width="120">
          </el-table-column>
          <el-table-column prop="cargoAmount" sortable label="货号" width="120">
          </el-table-column>
          <el-table-column prop="cargoWeight" sortable label="开单时间" width="120">
          </el-table-column>
          <el-table-column prop="cargoVolume" sortable label="出发城市" width="120">
          </el-table-column>
          <el-table-column prop="shipRemarks" sortable label="到达城市" width="120">
          </el-table-column>
          <el-table-column prop="shipRemarks" sortable label="货品名" width="120">
          </el-table-column>
          <el-table-column prop="shipRemarks" sortable label="件数" width="120">
          </el-table-column>
          <el-table-column prop="shipRemarks" sortable label="重量" width="120">
          </el-table-column>
          <el-table-column prop="shipRemarks" sortable label="体积" width="120">
          </el-table-column>
      ...
      <div slot="tableRight" class="tableHeadItemBtn">
        ...
        <el-table ref="multipleTableLeft" :data="rightTable" border @row-click="clickDetailsLeft" @selection-change="getSelectionLeft" tooltip-effect="dark" triped :key="tablekey" height="100%" :summary-method="getSumLeft" :default-sort="{prop: 'id', order: 'ascending'}" :show-summary='true' style="height:100%;">
          ...
          <el-table-column prop="repertoryAmount" sortable label="发货人" width="120">
          </el-table-column>
          <el-table-column prop="repertoryWeight" sortable label="收货人" width="120">
          </el-table-column>
          <el-table-column prop="repertoryVolume" sortable label="回扣" width="120">
          </el-table-column>
          <el-table-column prop="cargoAmount" sortable label="回扣结算状态" width="120">
          </el-table-column>
          <el-table-column prop="cargoWeight" sortable label="未结回扣" width="120">
          </el-table-column>
          <el-table-column prop="cargoVolume" sortable label="已结回扣" width="120">
          </el-table-column>
          <el-table-column prop="shipFromCityName" sortable label="实结回扣" width="120">
          </el-table-column>
          <el-table-column prop="shipToCityName" sortable label="发货方" width="120">
          </el-table-column>
          <el-table-column prop="shipToCityName" sortable label="收货方" width="120">
          </el-table-column>
          <el-table-column prop="shipToCityName" sortable label="货号" width="120">
          </el-table-column>
          <el-table-column prop="shipToCityName" sortable label="开单时间" width="120">
          </el-table-column>
          <el-table-column prop="shipToCityName" sortable label="出发城市" width="120">
          </el-table-column>
          <el-table-column prop="shipToCityName" sortable label="到达城市" width="120">
          </el-table-column>
          <el-table-column prop="shipSenderName" sortable label="货品名" width="120">
          </el-table-column>
          <el-table-column prop="shipSenderMobile" sortable label="件数" width="120">
          </el-table-column>
          <el-table-column prop="shipReceiverName" sortable label="重量" width="120">
          </el-table-column>
          <el-table-column prop="shipReceiverMobile" sortable label="体积" width="120">
          </el-table-column>
          <el-table-column prop="cargoName" sortable label="运单备注" width="120">
          </el-table-column>
        </el-table>
      </div>
    </transferTable>
