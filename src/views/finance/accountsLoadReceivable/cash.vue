<template>
  <div class="customer-manager tab-wrapper tab-wrapper-100 receivableTable" v-loading="loading">
    <div class="accountsLoad_table">
      ...
      <!-- 核销凭证 -->
      <Voucher :popVisible="popVisibleDialog" :info="infoTable" @close="closeDialog" :orgId="getRouteInfo.vo.ascriptionOrgId  ||  otherinfo.orgid"></Voucher>
...
export default {
  ...
  methods: {
    ...
    changLoadData(index, prop, newVal) {
      ...
      if (this.rightTable[index].notNowPayFee !== Number(newVal)) {
