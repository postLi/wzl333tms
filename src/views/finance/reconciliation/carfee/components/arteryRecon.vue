<template>
  ...
  <div class="ahort_lll" v-loading="loading" >
    <div class="sTop">
      <el-form :inline="true" :size="btnsize" label-position="center"   label-width="100px" class="short_searchinfo clearfix" ref="formName" :model="searchTitle">
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <span class="deletebtn" @click="iconDelete(scope.$index)"><icon-svg icon-class="delete_lll"  fill="red"></icon-svg></span>
            </template>
          </el-table-column>
          <el-table-column
            fixed
      ...
      <div class="info_tab">
        ...
        <el-table
          ...
          <el-table-column
            ...
            width="100">
            <template slot-scope="scope">
              <span class="deletebtn" @click="iconDeleteAl(scope.$index)"><icon-svg icon-class="delete_lll"  fill="red"></icon-svg></span>
            </template>
          </el-table-column>
          <el-table-column
            fixed
