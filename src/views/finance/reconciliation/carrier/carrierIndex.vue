  ...
  <div class="tab-content" v-loading="loading">
    ...
    <div class="tab_info">
      <div class="btns_box">
          ...
          <el-button type="primary" :size="btnsize" icon="el-icon-document" plain @click="doAction('storage')" v-has:FINANCE_CARRIERDETAIL>对账明细</el-button>
          <el-button type="primary" :size="btnsize" icon="el-icon-download" @click="doAction('export')" plain v-has:FINANCE_CARRIERPRI>导出</el-button>
