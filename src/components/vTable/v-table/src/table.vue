                                ...
                                <tr v-for="row in frozenTitleCols">
                                    <td v-for="(col, colIndex) in row"
                                        ...
                                        <div :class="['v-table-title-cell',showVerticalBorder?'vertical-border':'',showHorizontalBorder?'horizontal-border':'']"
                                             ...
                                             <!-- :style="{'width':titleColumnWidth(col.fields)+'px','min-height':minHeight + 'px','height':titleRowHeight ? titleRowHeight+'px' : 'auto','text-align':col.titleAlign}"> -->
                                            <span class="table-title" >
                                               <span v-if="isSelectionCol(col.fields)">
                                                ...
                                                <span  v-else-if="!noTitle" v-html="col.title"></span>
                                            ...
                                            <slot name="header" :row="setTableRow(col, colIndex)" class="v-slot-header"></slot>
                                        </div>
                                    </td>
                                </tr>
                            </template>
                                ...
                                <tr class="v-table-header-row">
                                    <td v-for="(col, colIndex) in frozenCols"
                                        ...
                                        <div :class="['v-table-title-cell',showVerticalBorder?'vertical-border':'',showHorizontalBorder?'horizontal-border':'']"
                                             ...
                                             <!-- :style="{'width':col.width+'px','min-height':minHeight+'px','height':titleRowHeight ? titleRowHeight+'px' : 'auto','text-align':col.titleAlign}"> -->
                                                <span class="table-title" >
                        ...
                        <template v-if="noFrozenTitleCols.length > 0">
                            <tr v-for="row in noFrozenTitleCols">
                                <td v-for="(col, colIndex) in row"
                                    ...
                                    <div :class="['v-table-title-cell',showVerticalBorder?'vertical-border':'',showHorizontalBorder?'horizontal-border':'']"
                                         :style="{'width':titleColumnWidth(col.fields)+'px','height':titleColumnHeight(col.rowspan)+'px','text-align':col.titleAlign}">
                                         <!-- :style="{'width':titleColumnWidth(col.fields)+'px','min-height':minHeight+'px','height':titleColumnHeight(col.rowspan) ? titleColumnHeight(col.rowspan)+'px' : 'auto','text-align':col.titleAlign}"> -->
                                        <slot name="header" :row="setTableRow(col, colIndex)" class="v-slot-header"></slot>
                                        <span class="table-title"  >
                                          <span v-if="isSelectionCol(col.fields)">
                                                 <v-checkbox
                            ...
                            <tr class="v-table-header-row">
                                <td v-for="(col,colIndex) in noFrozenCols"
                                    ...
                                    <div :class="['v-table-title-cell',showVerticalBorder?'vertical-border':'',showHorizontalBorder?'horizontal-border':'']"
                                         ...
                                         <!-- :style="{'width':col.width+'px','min-height':minHeight + 'px','height':titleRowHeight ? titleRowHeight+'px' :'auto','text-align':col.titleAlign}"> -->
                                         <slot name="header" :row="setTableRow(col, colIndex)" class="v-slot-header"></slot>
                                        <span class="table-title"  v-if="!noTitle">
                                            <span v-if="col.type === 'selection'">
                                                 <v-checkbox
                                                         @change="handleCheckAll"
                                                         :indeterminate="indeterminate"
...
<script>
    ...
    export default {
      ...
      methods: {
        setTableRow(row, index) {
            // 转换数据结构，匹配elementui常用规则
          return {
            $index: index,
            column: {
              label: row.title,
