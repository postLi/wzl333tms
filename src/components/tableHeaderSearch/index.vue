<template>
  <div class="table-header-wrapper">
    ...
    <!-- 下拉选择搜索 -->
    <SelectType v-model="queryString" v-else-if="isSelect" :size="btnsize" :type="curSelect.type" clearable placeholder="请选择" @click.stop.prevent.native @keyup.enter.native="event => changeEnter(scope.column, scope.$index, event)" @change="(val, obj) => changeKey(scope.column, scope.$index, (obj.dictName || ''))"></SelectType>
    <!-- 普通输入框 -->
